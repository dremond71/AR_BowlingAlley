...
public class GameBehaviour : MonoBehaviour
{
    ...
    int getTotalBalls()
    {
        ...
        GameObject[] balls = GameObject.FindGameObjectsWithTag("bowlingBall");
        if (null != balls)
        {
            total = balls.Length;
        }
    ...
    void kill_Ball_With_NullCheck()
    {
        try
        {
            ...
            {
                //MyDebug("Did not find a bowlingBall to kill");
            }
        }//try
        catch (Exception e)
        {
